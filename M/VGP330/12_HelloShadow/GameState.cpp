...
void GameState::Initialize() 
{
    ...
    mDirectionalLight.direction = MMath::Normalize({ 1.0f, -1.0f, 1.0f });
    ...
    //mStandartEffect.SetLightCamera(mShadowEffect.GetLightCamera());
    //mStandartEffect.SetShadowMap(&mShadowEffect.GetDepthMap());
