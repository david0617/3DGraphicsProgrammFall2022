...
{
    mVerticies.push_back({ MMath::Vector3(0.0f,-1.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(-0.5f,0.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.0f,0.0f,0.0f), Colors::Yellow });
    ...
    mVerticies.push_back({ MMath::Vector3(-0.5f,0.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(-0.25f,0.5f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.0f,0.0f,0.0f), Colors::Yellow });
...
{
    mVerticies.push_back({ MMath::Vector3(0.0f, 0.5f, 0.0f), Colors::Green });
    mVerticies.push_back({ MMath::Vector3(0.5f, -0.5f, 0.0f), Colors::Green });
    mVerticies.push_back({ MMath::Vector3(-0.5f, -0.5f, 0.0f), Colors::Green });
}

void Square::OnCreateShape()
{
    mVerticies.push_back({ MMath::Vector3(-0.9f,-0.9f,0.0f), Colors::LightYellow });
    mVerticies.push_back({ MMath::Vector3(-0.6f,0.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.0f,-0.9f,0.0f), Colors::OrangeRed });

    mVerticies.push_back({ MMath::Vector3(0.0f,-0.9f,0.0f), Colors::OrangeRed });
    mVerticies.push_back({ MMath::Vector3(-0.6f,0.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.3f,0.0f,0.0f), Colors::White });
...
{
    mVerticies.push_back({ MMath::Vector3(-1.0f,-1.0f,0.0f), Colors::Yellow });
    mVerticies.push_back({ MMath::Vector3(-0.5f,0.0f,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.0f,-1.0f,0.0f), Colors::Green });

    mVerticies.push_back({ MMath::Vector3(0.0f,-1.0f,0.0f), Colors::Yellow });
    mVerticies.push_back({ MMath::Vector3(0.5f,0.0,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(1.0f,-1.0f,0.0f), Colors::Green });

    mVerticies.push_back({ MMath::Vector3(-0.5f,0.0f,0.0f), Colors::Yellow });
    mVerticies.push_back({ MMath::Vector3(0.0f,1.0,0.0f), Colors::Red });
    mVerticies.push_back({ MMath::Vector3(0.5f,0.0f,0.0f), Colors::Green });
