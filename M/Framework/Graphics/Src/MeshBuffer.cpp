...
void M::Graphics::MeshBuffer::CreateVertexBuffer(const void* verticies, uint32_t vertexSize, uint32_t vertexCount)
{
...
void M::Graphics::MeshBuffer::CreateIndexBuffer(const uint32_t* indicies, uint32_t indexCount)
{
