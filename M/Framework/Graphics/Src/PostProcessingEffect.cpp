...
void PostProcessingEffect::Begin()
{
    ...
    switch (mMode)
    {
        case M::Graphics::PostProcessingEffect::Mode::None:
        {
            data.param0 = mMirrorScale;
            break;
        }
        case M::Graphics::PostProcessingEffect::Mode::Monochrome:
        {
            data.param0 = mMirrorScale;
            break;
        }
        case M::Graphics::PostProcessingEffect::Mode::Invert:
        {
            data.param0 = mMirrorScale;
            break;
        }
        case M::Graphics::PostProcessingEffect::Mode::Mirror:
        {
            data.param0 = mMirrorScale;
            break;
        }
        case M::Graphics::PostProcessingEffect::Mode::Blur:
        {
